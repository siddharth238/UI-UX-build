...
function Video({Src, left, title, text,link}) {
  return (
    ...
    <div className={left?"Video section__padding left":"gpt3__possibility section__padding"} id="possibility">
    <motion.div  whileInView={{ x: [left?70: -70, 0], opacity: [0, 1] }}
        transition={{ type: "spring", stiffness: 100   }} className="Video-image oveflowh">
    <ReactPlayer className='img' controls url={Src}/ >
    </motion.div>
    <motion.div   whileInView={{ x: [left?-70: 70, 0], opacity: [0, 1] }}
        transition={{ type: "spring", stiffness: 100   }} className="Video-content oveflowh">
